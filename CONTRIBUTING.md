...
Before you report an issue, or wish to add cool functionality please try and check to see if there are existing [issues](https://github.com/jfdm/freyja-schema/issues) and [pull requests](https://github.com/jfdm/freyja-schema/pulls).
...
1. Fork the [main development repository](https://github.com/jfdm/freyja-schema) on github e.g.
2. Clone your fork to your local machine:

```
$ git clone git@github.com/<your github user name>/freyja-schema.git
```

3. Add `jfdm/freyja-schema` as a remote upstream

```
$ git remote add upstream git@github.com:jfdm/freyja-schema.git
```
...
1. Go to GitHub and submit a pull request to `freyja-schema`
